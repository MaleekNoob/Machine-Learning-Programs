...
class FloatClassifier(assetManager: AssetManager, modelPath: String, labelPath: String, inputSize: Int) {
    ...
    private fun addPixelValue(imgData: ByteBuffer, pixelValue: Int): ByteBuffer {
