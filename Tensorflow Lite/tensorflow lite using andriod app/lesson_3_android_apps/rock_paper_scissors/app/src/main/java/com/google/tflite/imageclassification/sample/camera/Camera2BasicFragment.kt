...
import com.google.tflite.imageclassification.sample.tflite.FloatClassifier
...
class Camera2BasicFragment : Fragment(), View.OnClickListener,
    ...
    private val mModelPath = "rock_paper_scissors.tflite"
...
//                LOGGER.d("Initializing buffer %d at size %d", i, buffer.capacity())
    ...
    private lateinit var classifier: FloatClassifier
...
//        classifier = Classifier(activity!!.assets, mModelPath, mLabelPath, mInputSize);
        classifier = FloatClassifier(activity!!.assets, mModelPath, mLabelPath, mInputSize);
